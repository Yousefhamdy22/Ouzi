...
namespace Application.Services.Implemntation
{
    ...
    public class FawaterakPaymentService : IFawaterakPaymentService
    {
        ...
        public async Task<Domain.Enums.PaymentMethod> GetPaymentMethod(int paymentMethodId, IList<PaymentMethodsResponse.PaymentMethod>? paymentMethods = null)
        {
            ...
            if (string.IsNullOrWhiteSpace(method?.NameEn))
                return Domain.Enums.PaymentMethod.CreditCard;
            ...
            if (name.Contains("Meeza", StringComparison.OrdinalIgnoreCase) ||
                ...
                return Domain.Enums.PaymentMethod.Wallet;
